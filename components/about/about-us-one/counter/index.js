...
const Index = props => {
    ...
    return (
        <>
            ...
            <section className="iq-counter-section iq-pb-70">
                        ...
                        <div className="col-lg-6 mb-lg-0 mb-5">
                            ...
                            <div className="iq-list  iq-two-column">
                                <ul className="iq-list-with-icon">
                                    {
                                        List.map((list, index) => (
                                            <li key={index}  > <i className="ion ion-checkmark-round"></i>{list.title}</li>
                                        ))
                                    }
                                </ul>
                            </div>
                                ...
                                <div className="col-lg-6 col-md-6">
                                    {
                                        List1.map((list, index1) => (
                                            <div key={index1} className="iq-counter text-center iq-box-shadow iq-counter-style-1">
